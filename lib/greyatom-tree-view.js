...
class Main {
  ...
  deactivate() {
    ...
    if (atom.project.remoteftp.toolBar) {
      atom.project.remoteftp.toolBar.removeItems();
      atom.project.remoteftp.toolBar = null;
    }
  }
  ...
  consumeToolBar(getToolBar) {
    ...
    atom.project.remoteftp.toolBar.dashboardBtn = this.addButtonToToolbar({
      icon: 'tachometer',
    ...
    this.addButtonToToolbar({
      ...
      callback: () => {
        ...
        if (track) {
          atom.commands.dispatch(atom.views.getView(atom.workspace), 'commit-live:execute-task')
        } else {
