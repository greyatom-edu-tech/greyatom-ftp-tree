...
export default (function INIT() {
  class Client extends EventEmitter {
    ...
    doConnect(isReconnecting) {
      ...
      let connectingMsg = "Commit Live: Connecting...";
      if (isReconnecting) {
        connectingMsg = "Commit Live: Trying again..."
      }
    ...
    downloadPemFile(callback, isReconnecting) {
      let popUpMsg = "Commit Live: Preparing to connect...";
      if (isReconnecting) {
        popUpMsg = "Commit Live: Few more minutes...";
      }
      const downloadingFilePopup = new Notification("info", "Commit Live: Preparing to connect...", {
        dismissable: true
      });
