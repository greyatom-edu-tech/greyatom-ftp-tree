...
module.exports = ProjectTitle = (function (parent) {
  ...
  ProjectTitle.prototype.initialize = function () {
    ...
    const self = this;
    self.projectLabel.text('Current Project: ');
    self.projectTitle.text('Work with the IPL data set and do a deeper dive on looping constructs and various data structures');
