...
let __hasProp = {}.hasOwnProperty,
  ...
  ProjectTitleView = require('./project-title'),
...
module.exports = TreeView = (function (parent) {
  ...
  TreeView.prototype.initialize = function (state) {
    ...
    self.projectTitleView = new ProjectTitleView()
    self.root = new DirectoryView(atom.project.remoteftp.root);
    self.project = new ProjectView();
    self.root.expand();
    self.list.append(self.root);
    self.projectTabTitle.text('Task List');
    ...
    self.tabBar.on('click', '.tab', function (e) {
      ...
      if (e.target.textContent == 'Task List') {
        self.list.hide();
        self.project.show();
      } else {
        self.list.show();
    ...
    self.scroller.append(self.project);
  ...
  TreeView.prototype.attach = function () {
    ...
    this.projectTitleView.show();
    atom.config.set('tool-bar.visible', true);
    this.destroyTooltip();
    this.tooltip = atom.tooltips.add(
      atom.project.remoteftp.toolBar.dashboardBtn.element,
      {
        title: 'Dashboard',
        html: false,
        delay: {
  ...
  TreeView.prototype.destroyTooltip = function () {
    if (this.tooltip) {
